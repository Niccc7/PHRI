    ...
    <script>
        ...
        $(function() {
            $(document).on('submit', '#form_store-klasifikasi', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('dashboard.klasifikasi.store')}}",
            ...
            $(document).on('click', '.edit-klasifikasi', function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('dashboard.klasifikasi.edit', ':id') }}".replace(':id', klasifikasi_id),
                    success: function(response) {
            ...
            $(document).on('submit', '#form_update', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('dashboard.klasifikasi.update', ':id') }}".replace(':id', klasifikasi_id),
                    data: new FormData(this),
                    cache: false,
                    contentType: false,
                    processData: false,
